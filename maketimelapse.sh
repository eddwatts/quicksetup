...
echo 'WantedBy=multi-user.target' | sudo tee --append /etc/systemd/system/stimelapse.service
sudo curl -o "/home/timelapse.py" "https://raw.githubusercontent.com/eddwatts/quicksetup/master/timelapse.py?id=$RANDOM" -L
